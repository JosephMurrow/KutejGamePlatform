...
KINDS = ["p", "r", "n", "b", "q", "k"]
# Ряд листа, порог края и радиус замыкания.
#
# Пороги низкие, а замыкание широкое, и это подобрано по числу просветов внутри
# фигуры: при мягком замыкании контур не сходится в затенённых местах, фон
# протекает внутрь, и на светлом поле фигура просвечивает насквозь.
BANDS = {"w": (20, 445, 8, 15), "b": (465, 845, 8, 15)}
SIZE = 224
PAD = 6

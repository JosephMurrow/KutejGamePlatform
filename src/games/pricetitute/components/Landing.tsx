/**
 * Страница платитутки: правила, предупреждение про 18+ и вход за стол.
 *
 * Живёт под своим адресом и пока ещё под корневым: корень станет витриной
 * платформы на этапе 5 (docs/PLAN.md).
 */

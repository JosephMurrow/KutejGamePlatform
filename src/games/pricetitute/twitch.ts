import { MAX_SUM, NEVER, type Bet } from "@/games/pricetitute/engine/bet";
 ...
 * (SPEC §4). Разобрано в src/games/pricetitute/docs/BACKLOG.md P3: либо бот удаляет сообщение, либо

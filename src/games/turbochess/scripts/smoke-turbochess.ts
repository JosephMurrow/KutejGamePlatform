...
async function main() {
  ...
  /**
   * Колоды написаны всем одиннадцати, но проверка всё равно ищет говорящего:
   * если у какого-то характера реплики однажды пропадут, смоук это заметит, а
   * не промолчит вместе с ботом.
   */

...
/**
 * Во что подключение собирается играть. Отсутствие — не ошибка: так ходит
 * вкладка, открытая до появления платформы, и попасть она должна за свой стол,
 * а не в никуда (docs/BACKLOG.md A7).
 */
export const GAME_QUERY = "game";

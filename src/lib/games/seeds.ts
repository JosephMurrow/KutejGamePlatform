...
/**
 * Реестр сидов. Третий и последний реестр платформы — отдельно от клиентского
 * и серверного намеренно: за сидом тянутся все данные игры (у платитутки это
 * тысяча сто вопросов), и в работающем сервере им делать нечего.
 *

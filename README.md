...
Платформа с играми для компании. Пока игра одна — «Платитутка»: участники
угадывают, за какую сумму ведущий согласился бы совершить провокационное
действие, и кто ближе всех, тот забирает очко.

`pricetitute` осталось именем репозитория — с тех пор, когда игра и была всем
приложением.

Документация разведена надвое: по платформе — в [docs/](docs/README.md), по
самой игре — [рядом с её кодом](src/games/pricetitute/docs/README.md).

Начинать читать — с [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md): там про
границу между платформой и играми, а на ней держится вся раскладка проекта.
Оглавление и маршрут под задачу — в [docs/README.md](docs/README.md).
